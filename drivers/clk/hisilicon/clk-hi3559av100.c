...
#define pr_fmt(fmt)	"clk-hi3559av100: " fmt
...
static struct hisi_mux_clock hi3559av100_mux_clks_crg[] __initdata = {
	...
	{HI3559AV100_SYSAPB_MUX, "sysapb_mux", sysapb_mux_p,
	 ARRAY_SIZE(sysapb_mux_p),
	 CLK_SET_RATE_PARENT, 0xe8, 3, 1, 0, sysapb_mux_table},

	{HI3559AV100_SYSBUS_MUX, "sysbus_mux", sysbus_mux_p,
	 ARRAY_SIZE(sysbus_mux_p),
	...
	{HI3559AV100_A73_MUX, "a73_mux", a73_clksel_mux_p,
	 ARRAY_SIZE(a73_clksel_mux_p),
...
static void hi3559av100_calc_pll(u64 *frac_val, u32 *postdiv1_val,
				 u32 *postdiv2_val, u64 *fbdiv_val,
			    ...
			    unsigned long rate, unsigned long parent_rate)
{
	...
	u32 postdiv1_val, postdiv2_val, refdiv_val;
					 ...
					 unsigned long parent_rate)
{
	...
	if (refdiv_val == 0) {
		pr_err("%s: failed to refdiv_val is 0\n", __func__);
		return -1;
	}
...
int hisi_clk_register_pll(struct hi3559av100_pll_clock *clks,
...
static __init struct hisi_clock_data *hi3559av100_clk_register(struct
							       platform_device
							       *pdev)
{
	...
	ret = hisi_clk_register_pll(hi3559av100_pll_clks,
	...
	ret = hisi_clk_register_fixed_factor(hi3559av100_fixed_factor_clks,
					     ARRAY_SIZE
					     (hi3559av100_fixed_factor_clks),
					     clk_data);
	if (ret)
		goto unregister_mux;

	ret = hisi_clk_register_gate(hi3559av100_gate_clks,
				     ARRAY_SIZE(hi3559av100_gate_clks),
				     clk_data);
	if (ret)
...
static struct hisi_fixed_rate_clock
hi3559av100_shub_fixed_rate_clks[] __initdata = {
	{HI3559AV100_SHUB_SOURCE_SOC_24M, "clk_source_24M",
		NULL, 0, 24000000UL,},
	{HI3559AV100_SHUB_SOURCE_SOC_200M, "clk_source_200M",
		NULL, 0, 200000000UL,},
	{HI3559AV100_SHUB_SOURCE_SOC_300M, "clk_source_300M",
		NULL, 0, 300000000UL,},
...
struct hisi_divider_clock hi3559av100_shub_div_clks[] __initdata = {
	{HI3559AV100_SHUB_SPI_SOURCE_CLK, "clk_spi_clk", "shub_clk", 0, 0x20,
	 24, 2, CLK_DIVIDER_ALLOW_ZERO, shub_spi_clk_table,},
	{HI3559AV100_SHUB_UART_DIV_CLK, "clk_uart_div_clk", "shub_clk", 0, 0x1c,
	 28, 2, CLK_DIVIDER_ALLOW_ZERO, shub_uart_div_clk_table,},
};
...
static void __init hi3559av100_shub_clk_init(struct device_node *np)
{
	...
	hisi_clk_register_fixed_rate(hi3559av100_shub_fixed_rate_clks,
				     ARRAY_SIZE
				     (hi3559av100_shub_fixed_rate_clks),
				     clk_data);

	hisi_clk_register_mux(hi3559av100_shub_mux_clks,
			      ARRAY_SIZE(hi3559av100_shub_mux_clks), clk_data);

	hisi_clk_register_divider(hi3559av100_shub_div_clks,
...
CLK_OF_DECLARE(hi3559av100_shub_clk, "hisilicon,hi3559av100-shub-clock",
	       hi3559av100_shub_clk_init);
